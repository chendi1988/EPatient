...
public class registerActivity extends Activity {
    ...
    class RequestIdentify extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void... params) {
            return HttpPostUtil.getPostJsonResult(Contant.URL_SEND_IFYCODE,map,Contant.ACTION_IDENTIFY);
        }
    ...
    class RegisteTask extends AsyncTask<Void,Void,String>{
        ...
        @Override
        protected String doInBackground(Void... params) {
            return HttpPostUtil.getPostJsonResult(Contant.URL_REGISTER,map,Contant.ACTION_REGISTER);
        }
            ...
            if(s != null){
                try {
                    ...
                    if(resultStr.optString("status").equals("100")){
                        ...
                        setResult(Contant.FLAG_REGISTER,data);
                        finish();
                    }else{
    ...
    public void onBackPressed() {
        super.onBackPressed();
        setResult(Contant.FLAG_REGISTER);
    }
}
