...
import com.bean.adapters.MenuListAdapter;
import com.bean.adapters.OnMenuSelectedListener;
...
public class DropDownMenu extends LinearLayout{
    ...
    // Menu 展开的 list item
    private List<List<Map<String, String>>> mMenuItems=new ArrayList<List<Map<String, String>>>();
    ...
    // 设置 Menu的item
    public void setmMenuItems(List<List<Map<String, String>>> menuItems) {
        ...
        if (mDrawable) {
            ...
            mMenuList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    mTvMenuTitles.get(mColumnSelected).setText(mRowSelected == 0?mDefaultMenuTitle[mColumnSelected]:mMenuItems.get(mColumnSelected).get(mRowSelected).get("Name"));
            ...
            for (int i = 0; i < mMenuCount; i++) {
                ...
                if (mDefaultMenuTitle==null||mDefaultMenuTitle.length==0){
                    tv.setText(mMenuItems.get(i).get(0).get("name"));
                }else{
