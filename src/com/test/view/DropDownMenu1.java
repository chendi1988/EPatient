 ...
 */
public class DropDownMenu1 extends LinearLayout {
    ...
    public void initTabText(@NonNull List<String> tabTexts) {

        for (int i = 0; i < tabMenuView.getChildCount(); i = i + 2) {
            ((TextView) tabMenuView.getChildAt(i)).setText(tabTexts.get(i / 2).toString());
        }
    }
     ...
     * @param target
     */
    private void switchMenu(View target, boolean showmaskView) {
    ...
    public interface OnDoctorsOnClick {
        public void docOnClick();
    }

    public void setOnDoctorsOnClick(OnDoctorsOnClick doctors) {
        this.doctors = doctors;
    }

    OnDoctorsOnClick doctors;
}
