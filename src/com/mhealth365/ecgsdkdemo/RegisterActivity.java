...
public class RegisterActivity extends Activity{
	...
	EditText etName,etPhone,etCid,etOpenId,etUserName;
	EditText etEmail,etAge,etSex,etHeight;
	EditText etWeight,etHeartDisease,etAppeal,etMedicalHistory;
...
//					text ="注册信息错误，身高、体重、年龄不能是负数，手机号只支持11位手机号码（11位不包含+86）";
					text ="注册信息格式错误";//TODO 参数为空、超出范围等   OPENID 和 手机号码是必填项目
					break;
					//20150716----------------------------
				case SYS_0:
					text ="系统错误";//系统错误
